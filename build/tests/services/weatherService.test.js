...
describe('weatherService', () => {
    ...
    describe('getWeather', () => {
        ...
        it('debería llamar a la URL correcta con las coordenadas de Barcelona', async () => {
            ...
            await getWeather();
            expect(globalThis.fetch).toHaveBeenCalledWith('https://api.open-meteo.com/v1/forecast?latitude=41.3874&longitude=2.1686&current=temperature_2m,weather_code&timezone=Europe/Madrid');
        });
        it('debería lanzar un error cuando la respuesta no es ok', async () => {
            ...
            await expect(getWeather()).rejects.toThrow('Error al obtener información meteorológica');
        });
